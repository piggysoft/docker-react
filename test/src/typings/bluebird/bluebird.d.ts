...
declare class BluebirdPromise<R> implements BluebirdPromise.Thenable<R>, BluebirdPromise.Inspection<R> {
	...
	/**
	 * BluebirdPromises/A+ `.then()` with progress handler. Returns a new promise chained from this promise. The new promise will be rejected or resolved dedefer on the passed `fulfilledHandler`, `rejectedHandler` and the state of this promise.
	 */
	...
	/**
	 * Marks this promise as cancellable. BluebirdPromises by default are not cancellable after v0.11 and must be marked as such for `.cancel()` to have any effect. Marking a promise as cancellable is infectious and you don't need to remark any descendant promise.
	 */
	 ...
	 *
	 * BluebirdPromises are by default not cancellable. Use `.cancellable()` to mark a promise as cancellable.
	 */
	...
	/**
	 * Synchronously inspect the state of this `promise`. The `BluebirdPromiseInspection` will represent the state of the promise as snapshotted at the time of calling `.inspect()`.
	 */
	...
	* });
	 ...
	 */
	/**
	 * Same as calling `BluebirdPromise.all(thisBluebirdPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO type inference from array-resolving promise?
	all<U>(): BluebirdPromise<U[]>;

	/**
	 * Same as calling `BluebirdPromise.props(thisBluebirdPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO how to model instance.props()?
	props(): BluebirdPromise<Object>;

	/**
	 * Same as calling `BluebirdPromise.settle(thisBluebirdPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO type inference from array-resolving promise?
	settle<U>(): BluebirdPromise<BluebirdPromise.Inspection<U>[]>;

	/**
	 * Same as calling `BluebirdPromise.any(thisBluebirdPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO type inference from array-resolving promise?
	any<U>(): BluebirdPromise<U>;

	/**
	 * Same as calling `BluebirdPromise.some(thisBluebirdPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO type inference from array-resolving promise?
	some<U>(count: number): BluebirdPromise<U[]>;

	/**
	 * Same as calling `BluebirdPromise.race(thisBluebirdPromise, count)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO type inference from array-resolving promise?
	race<U>(): BluebirdPromise<U>;

	/**
	 * Same as calling `BluebirdPromise.map(thisBluebirdPromise, mapper)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO type inference from array-resolving promise?
	...
	/**
	 * Same as calling `BluebirdPromise.reduce(thisBluebirdPromise, Function reducer, initialValue)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO type inference from array-resolving promise?
	...
	/**
	 * Same as calling ``BluebirdPromise.filter(thisBluebirdPromise, filterer)``. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	// TODO type inference from array-resolving promise?
	...
	/**
	 * Same as calling ``BluebirdPromise.each(thisBluebirdPromise, iterator)``. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
	 */
	...
	/**
	 * Create a promise with undecided fate and return a `BluebirdPromiseResolver` to control it. See resolution?: BluebirdPromise(#promise-resolution).
	 */
...
declare module BluebirdPromise {
	...
	export interface Resolver<R> {
		...
		/**
		 * Gives you a callback representation of the `BluebirdPromiseResolver`. Note that this is not a method but a property. The callback accepts error object in first argument and success values on the 2nd parameter and the rest, I.E. node js conventions.
		 *
